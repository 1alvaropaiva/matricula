...
<body>
    ...
    <section class="cadastro">
        <form action="criar-usuario.php" method="POST">
            <h3 class="title mb-5"><b>Cadastrar novo aluno</b></h3>
            ...
            <div class="form-floating mb-3">
                ...
                <label class="nome" for="floatinEmail">Email</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="matricula" name="matricula" placeholder="Digite sua matrícula" required>
                <label class="matricula" for="floatinMatricula">Matricula</label>
            </div>
            <button class="btn btn-primary py-2"><b>Cadastrar</b></button>
        </form>
